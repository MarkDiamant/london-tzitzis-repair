    ...
    <div style={{width:"100%",height:"100%",display:"flex",position:"relative",overflow:"hidden",background:"linear-gradient(135deg,#fffdf9 0%,#f8f1e2 55%,#eedaa9 100%)",fontFamily:"Arial"}}>
      ...
      <div style={{width:"100%",height:"100%",display:"flex",padding:"48px 62px 46px 76px",gap:42,alignItems:"center"}}>
        <div style={{width:"68%",display:"flex",flexDirection:"column",justifyContent:"center"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",fontSize:62,lineHeight:.98,fontWeight:850,letterSpacing:-2.5,color:"#071d49"}}><span>Tallis tzitzis string</span><span style={{color:"#ad7f26"}}>replacement & repairs</span></div>
          ...
          <div style={{display:"flex",gap:12,marginTop:24}}><div style={{display:"flex",background:"#071d49",color:"white",borderRadius:14,padding:"12px 19px",fontSize:21,fontWeight:800}}>✓ All minhagim</div><div style={{display:"flex",background:"rgba(255,255,255,.82)",border:"1px solid #ddcfb1",color:"#34415d",borderRadius:14,padding:"12px 19px",fontSize:21,fontWeight:800}}>✓ Local service</div></div>
        </div>
